...
| 文案来源 | `CN-TASK-DRAFT.md` v1（PM 已批为 v1 文案），24 条逐条对齐 `tts-text-manifest.zh.json` |
...
「找到 dog」式中英混拼更是明确反模式（TL 综合裁定，见 `CN-TASK-DRAFT.md` #0）。生成脚本内已用
...
| click-faucet-on | 打开水龙头！ | `ta↓kʰai→ ʂwei↓lʊ↗ŋtʰou↗!` | 1.216 | -3.8 | -16.2 | 24k mono aac | 0.177 |
