...
- `batch-03`: 补齐 O-W 主体词。`owl`、`octopus`、`oven` 已由 `WTJ-20260704-043` 补齐，`pear`、`pencil`、`pizza` 已由 `WTJ-20260704-044` 补齐，`robot`、`rainbow`、`ring` 已由 `WTJ-20260704-046` 补齐，`sun`、`shoe`、`spoon` 已由 `WTJ-20260704-047` 补齐，`tree`、`train`、`turtle` 已由 `WTJ-20260704-048` 补齐，`queen`、`quilt`、`quail`、`quarter` 已由 `WTJ-20260704-045` 补齐，`umbrella`、`unicorn`、`ukulele`、`uniform` 已由 `WTJ-20260704-049` 补齐；剩余包括 `van`、`vase`、`violin`、`volcano`。
...
- `manifest.json` 共 100 个词；84 个 `ready`，16 个 `pending_sprite_stubbed`。
- 84 个 ready sprite 加 placeholder 均为 `1024x1024 RGBA`。
- 四角 alpha 均为 0。
