...
- `batch-04`: 补齐难字母和尾部词。`whale`、`watch`、`window`、`wagon` 已由 `WTJ-20260704-051` 补齐，`xylophone`、`xray` 已由 `WTJ-20260704-052` 补齐，`yoyo`、`yarn`、`yak` 已由 `WTJ-20260704-053` 补齐；剩余包括 `zebra`、`zipper`、`zucchini`。
...
- `manifest.json` 共 100 个词；97 个 `ready`，3 个 `pending_sprite_stubbed`。
- 97 个 ready sprite 加 placeholder 均为 `1024x1024 RGBA`。
- 四角 alpha 均为 0。
