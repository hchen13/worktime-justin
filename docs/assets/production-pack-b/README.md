...
- `manifest.json` 共 100 个词；55 个 `ready`，45 个 `pending_sprite_stubbed`。
- 55 个 ready sprite 加 placeholder 均为 `1024x1024 RGBA`。
- 四角 alpha 均为 0。
