...
test('1b. 全部 example 逐一 startTask，接上 voice-language.js 后：32 条已交付的均能 fetch 到各自 .zh.m4a（WTJ-20260705-024 CosyVoice3 全量重生成后，原 025 待交付的 8 条也已交付接线，无一 0-fetch 空跳过）', function () {
  var checked = 0;
  ...
  assert.equal(checkedPending, 0, 'WTJ-20260705-024 全量重生成交付后，不再有 voicePrompt 空字符串的待交付 example');
  console.log('PASS 1b: 32 条 example 均正确 fetch 到各自 .zh.m4a（024 交付后 8 条新任务也已接线），无一失声/播错。');
});
